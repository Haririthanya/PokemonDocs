...
function fetchPokemonData(pokemon){
    let url = pokemon.url // saving the pokemon url to a variable to use in the fetch. 
...
function renderPokemon(pokeData){
    ...
    let pokeContainer = document.createElement("div") // hold the data/details for indiviual pokemon.
    ...
    let pokeTypes = document.createElement('ul') //ul list  hold the pokemon types
...
function deleteEverything(event){
    ...
    generateBtn.innerText = "View All Pokemon"
